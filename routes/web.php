...
Route::middleware(['IsInstalled'])->group(function () {
    ...
    Route::get('/business/register/sub-type', 'BusinessController@getSubType');
...
//Account Confirmation Check new added
...
Route::middleware(['IsInstalled', 'auth', 'SetSessionData', 'language', 'timezone','SessionLock','AccountConfirmation'])->group(function () {
    ...
    //Product Custome Field new Added
    ...
    // Add new
    Route::get('purchases/suppliers/account-id','PurchaseController@getSupplierDefaultAccountId');
    Route::get('purchase/check-serial','PurchaseController@checkSerial');
    Route::get('purchase/get-product-info','PurchaseController@getProductName');
    ...
    Route::group(['prefix' => 'account'], function () {
        ...
        Route::get('get-district-list','AccountController@getDistrictList');
        Route::get('get-upazila-list','AccountController@getUpazilaList');
        Route::get('get-post-list','AccountController@getPostList');
        ...
        //Add new
        Route::get('/ladger/{id}', 'AccountController@getLedger');
