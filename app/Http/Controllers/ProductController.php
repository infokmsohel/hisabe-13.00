...
class ProductController extends Controller
{
     ...
     * @return void
     */
    public function __construct(ProductUtil $productUtil, ModuleUtil $moduleUtil, ProductSerial $serial)
    {
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $business_id = $request->session()->get('user.business_id');
            $product_details = $request->only(['name', 'brand_id', 'unit_id', 'category_id', 'tax', 'barcode_type', 'sku', 'alert_quantity', 'tax_type', 'weight', 'product_description','productType']);
    ...
    public function getProducts()
    {
        if (request()->ajax()) {
            ...
            if(!empty($term)){
                $term = $this->serial->getProductName($term);
            }
