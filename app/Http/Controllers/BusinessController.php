    ...
    public function postRegister(Request $request)
    {
        ...
        try {
            $validator = $request->validate(
                ...
                'surname' => 'max:10',
                'email' => 'sometimes|nullable|email|unique:users|max:100',
            ...
            $business_details = $request->only(['name','business_type_id','sub_type_id', 'start_date', 'currency_id', 'time_zone']);
            ...
            $business->enabled_modules = ['0'=>'account'];
            $business->save();
            ...
            $this->accountController->storeAccount($user->id,$business->id,$new_location->id,'');
