		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
							  ...
							  <div class="form-group" style="margin-bottom: 0px;">
								  <div class="input-group">
									<span class="input-group-addon">
									  ...
									  <input type="text" name="products[{{$row_count}}][warranty_period]" class = 'form-control input-sm mousetrap'>
									  {{--{!! Form::text('products[{{$row_count}}][warranty_type]warranty_period', null, ['class' => 'form-control input-sm mousetrap',--}}
						  ...
						  <div class="col-sm-6">
							  <div class="form-group" style="margin-bottom: 0px;">
								  ...
								  <div class="form-group">
									  ...
									  <select class=" form-control" id="warranty_type" name="products[{{$row_count}}][warranty_type]" class="form-control" required>
				  ...
				  <div class="form-group">
                              <label>@lang('lang_v1.input_serial')</label>
                              <input type="text" class="form-control" name="products[{{$row_count}}][serialNo]" placeholder="{{__('lang_v1.input_serial')}}">
                          </div>
		      	<div class="form-group">
