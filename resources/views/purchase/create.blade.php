	...
	@component('components.widget', ['class' => 'box-primary'])
		...
		<div class="row">
			<div class="col-sm-12">
                ...
                <!-- Multiple Serial -->
                <div class="row hidden" id="serial">
                    <div class="col-sm-12">
                        <div class="col-xs-6 col-sm-4">
                            <label>@lang('purchase.serial_number') <input type="radio"  value="inputSerial"  name="serial"></label> &nbsp;
                        </div>
                        <div class="col-xs-6 col-sm-4">
                            <label>@lang('purchase.generate_serial') <input type="radio"  value="generateSerial" name="serial"></label>
                        </div>
                    </div>
                    <div class="col-sm-12 hidden" id="inputSerial">
                        <div class="col-sm-6">
                            <textarea name="serialNumber" id="serialNumber" class="form-control" style="min-height:150px;" placeholder="Serial Number Here"></textarea>
                        </div>
                    </div>
                    <div class="col-sm-12 hidden" id="generateSerial">                    
                        ...
                        <div class="col-xs-3 col-sm-3">    
                            <div class="form-group">
                                <label>Start: </label>
                                <input type="number" value="1" name="startSerial" id="startSerial" class="form-control">
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3"> 
                            <div class="form-group">
                                <label>End: </label>
                                <input type="number" value="10" name="endSerial" id="endSerial" class="form-control">
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3"> 
                            <div class="form-group">
                                <label> &nbsp; </label><br>
                                <button class="btn btn-default" type="button" id="generateSerialIndex">Generate</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                            <input type="hidden" name="generateSerial" id="dyn-generateSerial" class="form-control">
                            <div class="hidden" id="after-generate-serial" style="height:100px;overflow: auto; border:1px solid #ddd;padding: 10px;border-radius:5px;">
                        </div>
                    </div>                    
                </div>
	@endcomponent
...
{!! Form::close() !!}
@include('purchase.partials.serialExistsMessage')
</section>
<!-- quick product modal -->
