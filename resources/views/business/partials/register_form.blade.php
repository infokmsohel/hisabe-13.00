...
<div class="col-md-12">
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('name', __('business.business_type') . ':' ) !!}
            <select class=" form-control" id="business_type_id" name="business_type_id" class="form-control" required>
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('name', __('business.sub_type') . ':' ) !!}
            <select class=" form-control" name="sub_type_id" id="sub_type_id" required></select>
        </div>
    </div>
